...
* [Vector](https://github.com/timberio/vector) ⭐ 22,452 | 🐛 2,519 | 🌐 Rust | 📅 2026-08-25 - A high-performance observability data pipeline.
...
* [tera](https://github.com/Keats/tera) ⭐ 4,295 | 🐛 9 | 🌐 Rust | 📅 2026-08-24 - A template engine for Rust based on Jinja2/Django.
...
* [AutoCorrect](https://github.com/huacnlee/autocorrect) ⭐ 1,627 | 🐛 7 | 🌐 Rust | 📅 2026-07-29 - A linter and formatter to help you to improve copywriting, correct spaces, words, and punctuations between CJK (Chinese, Japanese, Korean).
...
* [Woxi](https://github.com/ad-si/Woxi) ⭐ 893 | 🐛 11 | 🌐 Rust | 📅 2026-08-25 - Interpreter and computer algebra system for a subset of the Wolfram Language.
...
* [PTA-Parser](https://github.com/AltaModaTech/pta-parser/) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2024-06-10 - A Plain Text Accounting parser built in Rust for [Beancount](https://github.com/beancount/beancount) ⭐ 5,938 | 🐛 237 | 🌐 Python | 📅 2026-08-23, [Ledger](https://github.com/ledger/ledger) ⭐ 6,017 | 🐛 14 | 🌐 C++ | 📅 2026-08-22, and other PTA formats.
