...
* [Vector](https://github.com/timberio/vector) ⭐ 22,408 | 🐛 2,520 | 🌐 Rust | 📅 2026-08-18 - A high-performance observability data pipeline.
...
* [tera](https://github.com/Keats/tera) ⭐ 4,289 | 🐛 13 | 🌐 Rust | 📅 2026-08-18 - A template engine for Rust based on Jinja2/Django.
...
* [Woxi](https://github.com/ad-si/Woxi) ⭐ 875 | 🐛 3 | 🌐 Rust | 📅 2026-08-19 - Interpreter and computer algebra system for a subset of the Wolfram Language.
...
* [PTA-Parser](https://github.com/AltaModaTech/pta-parser/) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2024-06-10 - A Plain Text Accounting parser built in Rust for [Beancount](https://github.com/beancount/beancount) ⭐ 5,917 | 🐛 235 | 🌐 Python | 📅 2026-05-18, [Ledger](https://github.com/ledger/ledger) ⭐ 6,012 | 🐛 16 | 🌐 C++ | 📅 2026-07-03, and other PTA formats.
