...
[<img src="https://avatars.githubusercontent.com/u/26044607" align="right" width="100">](https://github.com/pest-parser/pest/) ⭐ 5,400 | 🐛 66 | 🌐 Rust | 📅 2026-09-17
...
* [GitHub Discussions](https://github.com/pest-parser/pest/discussions) ⭐ 5,400 | 🐛 66 | 🌐 Rust | 📅 2026-09-17

## Projects

Here are some example projects using pest:

* [Vector](https://github.com/timberio/vector) ⭐ 22,579 | 🐛 2,482 | 🌐 Rust | 📅 2026-09-17 - A high-performance observability data pipeline.
* [pest\_meta](https://github.com/pest-parser/pest/blob/master/meta/src/grammar.pest) ⭐ 5,400 | 🐛 66 | 🌐 Rust | 📅 2026-09-17 - The pest itself is bootstrapped using pest.
...
* [tera](https://github.com/Keats/tera) ⭐ 4,306 | 🐛 4 | 🌐 Rust | 📅 2026-09-11 - A template engine for Rust based on Jinja2/Django.
* [insta](https://github.com/mitsuhiko/insta) ⭐ 2,962 | 🐛 73 | 🌐 Rust | 📅 2026-09-06 - A snapshot testing library for rust.
* [ZoKrates](https://github.com/ZoKrates/ZoKrates) ⭐ 1,870 | 🐛 115 | 🌐 Rust | 📅 2024-08-01 - A toolbox for zkSNARKs on Ethereum.
* [jql](https://github.com/yamafaktory/jql) ⭐ 1,681 | 🐛 0 | 🌐 Rust | 📅 2026-09-08 - A JSON Query Language CLI tool.
* [AutoCorrect](https://github.com/huacnlee/autocorrect) ⭐ 1,630 | 🐛 8 | 🌐 Rust | 📅 2026-08-26 - A linter and formatter to help you to improve copywriting, correct spaces, words, and punctuations between CJK (Chinese, Japanese, Korean).
* [handlebars-rust](https://github.com/sunng87/handlebars-rust) ⭐ 1,486 | 🐛 43 | 🌐 Rust | 📅 2026-09-12 - Rust templating with Handlebars.
* [cicada](https://github.com/mitnk/cicada) ⭐ 1,006 | 🐛 0 | 🌐 Rust | 📅 2026-08-22 - An old-school bash-like Unix shell written in Rust.
* [Woxi](https://github.com/ad-si/Woxi) ⭐ 920 | 🐛 15 | 🌐 Rust | 📅 2026-09-17 - Interpreter and computer algebra system for a subset of the Wolfram Language.
...
* [TypeQL Rust](https://github.com/typedb/typeql/tree/master/rust) ⭐ 254 | 🐛 49 | 🌐 Rust | 📅 2026-09-17 - TypeDB's query language, written in Pest
* [json5-rs](https://github.com/callum-oakley/json5-rs) ⭐ 246 | 🐛 5 | 🌐 Rust | 📅 2026-02-07 - A Rust JSON5 serializer and deserializer which speaks Serde.
* [Keadex Mina](https://github.com/keadex/keadex) ⭐ 203 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-14 - Open Source, serverless IDE to code with C4-PlantUML and organize at a scale C4 model diagrams.
...
* [Amble](https://github.com/pygmy-twylyte/amble) ⭐ 28 | 🐛 5 | 🌐 Rust | 📅 2026-08-07 - Parser (text adventure) game development platform (uses Pest both for parsing player input and for the DSL used in world creation).
...
* [PTA-Parser](https://github.com/AltaModaTech/pta-parser/) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2024-06-10 - A Plain Text Accounting parser built in Rust for [Beancount](https://github.com/beancount/beancount) ⭐ 6,010 | 🐛 238 | 🌐 Python | 📅 2026-08-23, [Ledger](https://github.com/ledger/ledger) ⭐ 6,037 | 🐛 19 | 🌐 C++ | 📅 2026-09-05, and other PTA formats.
...
* [pest-ast](https://github.com/pest-parser/ast) ⭐ 92 | 🐛 21 | 🌐 Rust | 📅 2026-07-22 - It can help to reduce boilerplate when converting pest parse trees to abstract syntax trees.
