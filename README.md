...
[<img src="https://avatars.githubusercontent.com/u/26044607" align="right" width="100">](https://github.com/pest-parser/pest/) ⭐ 5,402 | 🐛 65 | 🌐 Rust | 📅 2026-09-26
...
* [GitHub Discussions](https://github.com/pest-parser/pest/discussions) ⭐ 5,402 | 🐛 65 | 🌐 Rust | 📅 2026-09-26

## Projects

Here are some example projects using pest:

* [Vector](https://github.com/timberio/vector) ⭐ 22,619 | 🐛 2,484 | 🌐 Rust | 📅 2026-09-25 - A high-performance observability data pipeline.
...
* [tera](https://github.com/Keats/tera) ⭐ 4,314 | 🐛 4 | 🌐 Rust | 📅 2026-09-11 - A template engine for Rust based on Jinja2/Django.
...
* [AutoCorrect](https://github.com/huacnlee/autocorrect) ⭐ 1,643 | 🐛 8 | 🌐 Rust | 📅 2026-08-26 - A linter and formatter to help you to improve copywriting, correct spaces, words, and punctuations between CJK (Chinese, Japanese, Korean).
...
* [Woxi](https://github.com/ad-si/Woxi) ⭐ 923 | 🐛 12 | 🌐 Rust | 📅 2026-09-26 - Interpreter and computer algebra system for a subset of the Wolfram Language.
...
* [Amble](https://github.com/pygmy-twylyte/amble) ⭐ 28 | 🐛 5 | 🌐 Rust | 📅 2026-09-26 - Parser (text adventure) game development platform (uses Pest both for parsing player input and for the DSL used in world creation).
...
* [PTA-Parser](https://github.com/AltaModaTech/pta-parser/) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2024-06-10 - A Plain Text Accounting parser built in Rust for [Beancount](https://github.com/beancount/beancount) ⭐ 6,036 | 🐛 241 | 🌐 Python | 📅 2026-08-23, [Ledger](https://github.com/ledger/ledger) ⭐ 6,043 | 🐛 18 | 🌐 C++ | 📅 2026-09-22, and other PTA formats.
