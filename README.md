...
* [Vector](https://github.com/timberio/vector) ⭐ 22,381 | 🐛 2,519 | 🌐 Rust | 📅 2026-08-17 - A high-performance observability data pipeline.
...
* [tera](https://github.com/Keats/tera) ⭐ 4,287 | 🐛 12 | 🌐 Rust | 📅 2026-08-13 - A template engine for Rust based on Jinja2/Django.
* [insta](https://github.com/mitsuhiko/insta) ⭐ 2,947 | 🐛 71 | 🌐 Rust | 📅 2026-08-17 - A snapshot testing library for rust.
...
* [Woxi](https://github.com/ad-si/Woxi) ⭐ 867 | 🐛 6 | 🌐 Rust | 📅 2026-08-17 - Interpreter and computer algebra system for a subset of the Wolfram Language.
...
* [json5-rs](https://github.com/callum-oakley/json5-rs) ⭐ 240 | 🐛 5 | 🌐 Rust | 📅 2026-02-07 - A Rust JSON5 serializer and deserializer which speaks Serde.
...
* [PTA-Parser](https://github.com/AltaModaTech/pta-parser/) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2024-06-10 - A Plain Text Accounting parser built in Rust for [Beancount](https://github.com/beancount/beancount) ⭐ 5,911 | 🐛 235 | 🌐 Python | 📅 2026-05-18, [Ledger](https://github.com/ledger/ledger) ⭐ 6,012 | 🐛 16 | 🌐 C++ | 📅 2026-07-03, and other PTA formats.
