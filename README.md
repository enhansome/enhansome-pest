...
* [Vector](https://github.com/timberio/vector) ⭐ 22,438 | 🐛 2,525 | 🌐 Rust | 📅 2026-08-22 - A high-performance observability data pipeline.
...
* [tera](https://github.com/Keats/tera) ⭐ 4,291 | 🐛 8 | 🌐 Rust | 📅 2026-08-23 - A template engine for Rust based on Jinja2/Django.
...
* [Woxi](https://github.com/ad-si/Woxi) ⭐ 890 | 🐛 11 | 🌐 Rust | 📅 2026-08-23 - Interpreter and computer algebra system for a subset of the Wolfram Language.
...
* [PTA-Parser](https://github.com/AltaModaTech/pta-parser/) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2024-06-10 - A Plain Text Accounting parser built in Rust for [Beancount](https://github.com/beancount/beancount) ⭐ 5,933 | 🐛 236 | 🌐 Python | 📅 2026-05-18, [Ledger](https://github.com/ledger/ledger) ⭐ 6,015 | 🐛 14 | 🌐 C++ | 📅 2026-08-22, and other PTA formats.
