...
* [Vector](https://github.com/timberio/vector) ⭐ 22,585 | 🐛 2,486 | 🌐 Rust | 📅 2026-09-18 - A high-performance observability data pipeline.
...
* [tera](https://github.com/Keats/tera) ⭐ 4,307 | 🐛 4 | 🌐 Rust | 📅 2026-09-11 - A template engine for Rust based on Jinja2/Django.
...
* [AutoCorrect](https://github.com/huacnlee/autocorrect) ⭐ 1,632 | 🐛 8 | 🌐 Rust | 📅 2026-08-26 - A linter and formatter to help you to improve copywriting, correct spaces, words, and punctuations between CJK (Chinese, Japanese, Korean).
...
* [Woxi](https://github.com/ad-si/Woxi) ⭐ 920 | 🐛 7 | 🌐 Rust | 📅 2026-09-19 - Interpreter and computer algebra system for a subset of the Wolfram Language.
...
* [PTA-Parser](https://github.com/AltaModaTech/pta-parser/) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2024-06-10 - A Plain Text Accounting parser built in Rust for [Beancount](https://github.com/beancount/beancount) ⭐ 6,014 | 🐛 238 | 🌐 Python | 📅 2026-08-23, [Ledger](https://github.com/ledger/ledger) ⭐ 6,039 | 🐛 17 | 🌐 C++ | 📅 2026-09-05, and other PTA formats.
