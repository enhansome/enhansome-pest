...
* [Vector](https://github.com/timberio/vector) ⭐ 22,365 | 🐛 2,514 | 🌐 Rust | 📅 2026-08-15 - A high-performance observability data pipeline.
...
* [handlebars-rust](https://github.com/sunng87/handlebars-rust) ⭐ 1,479 | 🐛 42 | 🌐 Rust | 📅 2026-08-12 - Rust templating with Handlebars.
* [cicada](https://github.com/mitnk/cicada) ⭐ 1,006 | 🐛 0 | 🌐 Rust | 📅 2026-08-08 - An old-school bash-like Unix shell written in Rust.
* [Woxi](https://github.com/ad-si/Woxi) ⭐ 856 | 🐛 4 | 🌐 Rust | 📅 2026-08-16 - Interpreter and computer algebra system for a subset of the Wolfram Language.
...
* [PTA-Parser](https://github.com/AltaModaTech/pta-parser/) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2024-06-10 - A Plain Text Accounting parser built in Rust for [Beancount](https://github.com/beancount/beancount) ⭐ 5,907 | 🐛 235 | 🌐 Python | 📅 2026-05-18, [Ledger](https://github.com/ledger/ledger) ⭐ 6,011 | 🐛 16 | 🌐 C++ | 📅 2026-07-03, and other PTA formats.
