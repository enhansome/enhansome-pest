...
[<img src="https://avatars.githubusercontent.com/u/26044607" align="right" width="100">](https://github.com/pest-parser/pest/) ⭐ 5,382 | 🐛 64 | 🌐 Rust | 📅 2026-08-20
...
* [GitHub Discussions](https://github.com/pest-parser/pest/discussions) ⭐ 5,382 | 🐛 64 | 🌐 Rust | 📅 2026-08-20

## Projects

Here are some example projects using pest:

* [Vector](https://github.com/timberio/vector) ⭐ 22,458 | 🐛 2,529 | 🌐 Rust | 📅 2026-08-26 - A high-performance observability data pipeline.
* [pest\_meta](https://github.com/pest-parser/pest/blob/master/meta/src/grammar.pest) ⭐ 5,382 | 🐛 64 | 🌐 Rust | 📅 2026-08-20 - The pest itself is bootstrapped using pest.
...
* [tera](https://github.com/Keats/tera) ⭐ 4,296 | 🐛 9 | 🌐 Rust | 📅 2026-08-26 - A template engine for Rust based on Jinja2/Django.
* [insta](https://github.com/mitsuhiko/insta) ⭐ 2,950 | 🐛 71 | 🌐 Rust | 📅 2026-08-17 - A snapshot testing library for rust.
...
* [Woxi](https://github.com/ad-si/Woxi) ⭐ 894 | 🐛 9 | 🌐 Rust | 📅 2026-08-26 - Interpreter and computer algebra system for a subset of the Wolfram Language.
...
* [json5-rs](https://github.com/callum-oakley/json5-rs) ⭐ 242 | 🐛 5 | 🌐 Rust | 📅 2026-02-07 - A Rust JSON5 serializer and deserializer which speaks Serde.
* [Keadex Mina](https://github.com/keadex/keadex) ⭐ 203 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-26 - Open Source, serverless IDE to code with C4-PlantUML and organize at a scale C4 model diagrams.
...
* [PTA-Parser](https://github.com/AltaModaTech/pta-parser/) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2024-06-10 - A Plain Text Accounting parser built in Rust for [Beancount](https://github.com/beancount/beancount) ⭐ 5,941 | 🐛 236 | 🌐 Python | 📅 2026-08-23, [Ledger](https://github.com/ledger/ledger) ⭐ 6,018 | 🐛 15 | 🌐 C++ | 📅 2026-08-22, and other PTA formats.
