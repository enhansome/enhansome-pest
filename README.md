...
* [Vector](https://github.com/timberio/vector) ⭐ 22,529 | 🐛 2,515 | 🌐 Rust | 📅 2026-09-09 - A high-performance observability data pipeline.
...
* [tera](https://github.com/Keats/tera) ⭐ 4,301 | 🐛 8 | 🌐 Rust | 📅 2026-09-09 - A template engine for Rust based on Jinja2/Django.
...
* [jql](https://github.com/yamafaktory/jql) ⭐ 1,677 | 🐛 0 | 🌐 Rust | 📅 2026-09-08 - A JSON Query Language CLI tool.
...
* [Woxi](https://github.com/ad-si/Woxi) ⭐ 913 | 🐛 5 | 🌐 Rust | 📅 2026-09-09 - Interpreter and computer algebra system for a subset of the Wolfram Language.
...
* [TypeQL Rust](https://github.com/typedb/typeql/tree/master/rust) ⭐ 254 | 🐛 47 | 🌐 Rust | 📅 2026-09-09 - TypeDB's query language, written in Pest
...
* [PTA-Parser](https://github.com/AltaModaTech/pta-parser/) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2024-06-10 - A Plain Text Accounting parser built in Rust for [Beancount](https://github.com/beancount/beancount) ⭐ 5,982 | 🐛 237 | 🌐 Python | 📅 2026-08-23, [Ledger](https://github.com/ledger/ledger) ⭐ 6,031 | 🐛 18 | 🌐 C++ | 📅 2026-09-05, and other PTA formats.
