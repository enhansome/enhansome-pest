...
* [Vector](https://github.com/timberio/vector) ⭐ 22,538 | 🐛 2,514 | 🌐 Rust | 📅 2026-09-10 - A high-performance observability data pipeline.
...
* [tera](https://github.com/Keats/tera) ⭐ 4,303 | 🐛 8 | 🌐 Rust | 📅 2026-09-09 - A template engine for Rust based on Jinja2/Django.
...
* [Woxi](https://github.com/ad-si/Woxi) ⭐ 914 | 🐛 5 | 🌐 Rust | 📅 2026-09-10 - Interpreter and computer algebra system for a subset of the Wolfram Language.
...
* [PTA-Parser](https://github.com/AltaModaTech/pta-parser/) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2024-06-10 - A Plain Text Accounting parser built in Rust for [Beancount](https://github.com/beancount/beancount) ⭐ 5,987 | 🐛 237 | 🌐 Python | 📅 2026-08-23, [Ledger](https://github.com/ledger/ledger) ⭐ 6,033 | 🐛 18 | 🌐 C++ | 📅 2026-09-05, and other PTA formats.
