...
[<img src="https://avatars.githubusercontent.com/u/26044607" align="right" width="100">](https://github.com/pest-parser/pest/) ⭐ 5,390 | 🐛 64 | 🌐 Rust | 📅 2026-08-20
...
* [GitHub Discussions](https://github.com/pest-parser/pest/discussions) ⭐ 5,390 | 🐛 64 | 🌐 Rust | 📅 2026-08-20

## Projects

Here are some example projects using pest:

* [Vector](https://github.com/timberio/vector) ⭐ 22,504 | 🐛 2,513 | 🌐 Rust | 📅 2026-09-01 - A high-performance observability data pipeline.
* [pest\_meta](https://github.com/pest-parser/pest/blob/master/meta/src/grammar.pest) ⭐ 5,390 | 🐛 64 | 🌐 Rust | 📅 2026-08-20 - The pest itself is bootstrapped using pest.
...
* [tera](https://github.com/Keats/tera) ⭐ 4,299 | 🐛 9 | 🌐 Rust | 📅 2026-09-01 - A template engine for Rust based on Jinja2/Django.
...
* [Woxi](https://github.com/ad-si/Woxi) ⭐ 904 | 🐛 9 | 🌐 Rust | 📅 2026-09-01 - Interpreter and computer algebra system for a subset of the Wolfram Language.
...
* [TypeQL Rust](https://github.com/typedb/typeql/tree/master/rust) ⭐ 254 | 🐛 46 | 🌐 Rust | 📅 2026-09-01 - TypeDB's query language, written in Pest
...
* [qubit](https://github.com/abhimanyu003/qubit) ⭐ 98 | 🐛 1 | 🌐 Rust | 📅 2022-01-17 - A handy calculator, based on Rust and WebAssembly.
...
* [PTA-Parser](https://github.com/AltaModaTech/pta-parser/) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2024-06-10 - A Plain Text Accounting parser built in Rust for [Beancount](https://github.com/beancount/beancount) ⭐ 5,958 | 🐛 238 | 🌐 Python | 📅 2026-08-23, [Ledger](https://github.com/ledger/ledger) ⭐ 6,024 | 🐛 19 | 🌐 C++ | 📅 2026-08-28, and other PTA formats.
